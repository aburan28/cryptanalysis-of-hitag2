// Software optimized 48-bit Philips/NXP Mifare Hitag2 PCF7936/46/47/52 
// stream cipher algorithm by I.C. Wiener 2006-2007.
...
#define rev8(x)			((((x)>>7)&1)+((((x)>>6)&1)<<1)+((((x)>>5)&1)<<2)+((((x)>>4)&1)<<3)+
				((((x)>>3)&1)<<4)+((((x)>>2)&1)<<5)+((((x)>>1)&1)<<6)+(((x)&1)<<7))
